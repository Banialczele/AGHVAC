const TRANSLATION = {
  ...
  signallerWarning: {
    pl: "Zbyt duża liczba sygnalizatorów na magistrali! Max 26szt!",
    en: "Too many signallers on a bus! Maximum allowed - 26pcs!",
  },
  valveWarning: {
    pl: "Zbyt duża liczba zaworów na magistrali! Max 8szt!",
    en: "Too many valves on a bus! Maximum allowed - 8pcs!",
  },
  busWarning: {
    pl: "Zbyt duża liczba urządzeń na magistrali! Max 50szt wliczająć jednostkę sterującą!",
    en: "Too many devices on a bus! Max 50pcs including control unit!",
  },
};
